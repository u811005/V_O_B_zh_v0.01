...
const dictionaryData = {
  ...
  "家政": {
    description: "資金を少量得られる手段。",
    details: [
      "消耗: 15體力  15精神",
      "資金基本値 = 5 + 10 * ((靈巧/20) * (勤奮/20))",
      "機率上升: 靈巧 勤奮"
    ]
  },
  "魔法細工": {
    description: "資金を得られる手段。",
    details: [
      "消耗: 15體力  15精神",
      "資金基本値 = 5 + 10 * ((靈巧/20) * (魔力/20))"
    ]
  },
  "研究": {
    description: "技術を得られる手段。",
    details: [
      "消耗: 15體力  30精神",
      "技術基本値 = 15 + 30 * ((智力/20) * (魔力/20))",
      "機率上升: 魔力 智力"
    ]
  },
  "警備": {
    description: "治安を得られる手段。",
    details: [
      "消耗: 15體力  30精神",
      "治安基本値 = (勇氣+道德) / 50",
      "機率上升: 力量 道德"
  ...
  "看護": {
    description: "最も体力の低い村人?(隨機)を回復させる。",
    details: [
      "体力コスト: 20 * (1-耐力/100)",
      "メンタルコスト: 20 * (1-道德/100)",
      "回復量 = 20 * (魔力/20) * (道德/20)",
